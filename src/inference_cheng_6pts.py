...
from custom_comp.zoo import models,model_loading,Cheng2020Attention
...
if __name__ == "__main__":
    ...
    checkpoint_path = "/home/ids/flauron-23/MagV/data/magv_40_cheng_6_pts/models/magv_40_cheng_6_pts_checkpoint_20.pth.tar"    
    mask_path ="/home/ids/flauron-23/MagV/data/magv_40_cheng_6_pts/masks/mask_magv_40_cheng_6_pts.pth"
    ...
    if log_wandb:
        wandb.init(
            project='training',
            entity='MagV',
            name='inference_cheng_6pts',
        )

    make_plot("cheng",net,oldMask,None,parameters_to_prune,"cuda",dataloader,"inference_cheng_6pts",log_wandb=log_wandb,max_images=30,anchor = True)
