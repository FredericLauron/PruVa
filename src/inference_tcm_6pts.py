...
if __name__ == "__main__":
    ...
    # Load model and mask
    checkpoint_path = "/home/ids/flauron-23/MagV/data/magv_40_tcm/models/magv_40_tcm_checkpoint.pth.tar"    
    mask_path ="/home/ids/flauron-23/MagV/data/magv_40_tcm/masks/mask_magv_40_tcm.pth"
    ...
    if log_wandb:
        wandb.init(
            project='training',
            entity='MagV',
            name='inference_tcm_6pts',
        )

    make_plot("tcm",net,oldMask,None,parameters_to_prune,"cuda",dataloader,"inference_tcm_6pts",log_wandb=log_wandb,max_images=30,anchor=True)
