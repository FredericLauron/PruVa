...
from custom_comp.zoo import models,model_loading,TCM,rewire_g_a_s
...
if __name__ == "__main__":
    ...
    # Load model and mask
    checkpoint_path = "/home/ids/flauron-23/MagV/data/magv_40_tcm_14_pts/models/magv_40_tcm_14_pts_checkpoint_best.pth.tar"    
    mask_path ="/home/ids/flauron-23/MagV/data/magv_40_tcm_14_pts/masks/mask_magv_40_tcm_14_pts.pth"
    
    net = model_loading(model_class = TCM,state_dict_path=checkpoint_path,preprocess=None,postprocess=None)[1]
    ...
    if log_wandb:
        wandb.init(
            project='training',
            entity='MagV',
            name='inference_tcm_14pts',
        )

    make_plot("tcm",net,oldMask,None,parameters_to_prune,"cuda",dataloader,"inference_tcm_14pts",log_wandb=log_wandb,max_images=30)
